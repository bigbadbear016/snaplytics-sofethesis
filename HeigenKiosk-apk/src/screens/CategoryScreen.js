...
export default function CategoryScreen({
  ...
  const hasCategoryCache = cachedCategories != null;
  const { data: fetchedCategories, loading, error, refetch } = useApi(
    fetchCategories,
    [],
    { enabled: !hasCategoryCache },
  );
  const categories = hasCategoryCache ? cachedCategories : fetchedCategories;
