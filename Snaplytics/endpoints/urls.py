...
from .views import (
    ...
    auth_staff_account_restore,
    auth_staff_account_purge,
    action_logs,
    recycle_bin,
    coupon_validate,
    customer_coupons,
...
urlpatterns = [
    ...
    path(
        "auth/staff-accounts/<int:user_id>/restore/",
        auth_staff_account_restore,
        name="auth-staff-account-restore",
    ),
    path(
        "auth/staff-accounts/<int:user_id>/purge/",
        auth_staff_account_purge,
        name="auth-staff-account-purge",
    ),
